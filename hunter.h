...
REGISTER_HUNTERCLASS(ID_ASSASSIN, MASK_ID_ASSASSIN, TEAM_HUNTER, OnAssassinDeath, OnAssassinFire, OnAssassinDoDmg, OnAssassinSpawn, OnAssassinTakeDmg) // Assassin
...
public:
	...
	virtual void OnCharacterTick(class CCharacter *pChr) override;
...
protected:
	...
	int m_AssassinInvTime;
	int m_AssassinChargeTime
	...
	// Assassin class
	bool OnAssassinFire(class CWeapon *pWeapon, vec2 Direction);
	void OnAssassinSpawn(class CCharacter *pChr);
	int OnAssassinDeath(class CCharacter *pVictim, class CPlayer *pKiller, int Weapon);
	int OnAssassinDoDmg(class CCharacter *pChr, vec2 &Force, int &Dmg, int From, int WeaponType, int WeaponID, bool IsExplosion);
	int OnAssassinTakeDmg(class CCharacter *pChr, vec2 &Force, int &Dmg, int From, int WeaponType, int WeaponID, bool IsExplosion);
	static bool OnAssassinGrenadeCollide(CProjectile *pProj, vec2 Pos, CCharacter *pHit, bool EndOfLife);
